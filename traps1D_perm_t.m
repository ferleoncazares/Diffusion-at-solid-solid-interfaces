...
% H:        Total amount of solute in the sample [mol]
 ...
 %% Function
function [xr,x,t,ts,clr,cl,civ,Js1,Js2,Ji,H] = traps1D_perm_t(xs,xi,T0,dx,dt,tend,S1,D01,Q1,Eb1,S2,D02,Q2,Eb2,St,DeltaE,DeltaEt,D0t,a,cs1,cs2,c1_ini,c2_ini,coord,l,nsvs)
...
for j = 1:(length(t)-1)                 % T loop
    ...
    [clj(I),HI,ci(1),ci(2),ci(3)] = redist(HI+Jx0(I-1)*dt,DeltaE1t,DeltaE2t,clj(I-1),clj(I+1),dx,x(I-1),l,Vi(2),D1,D2,Db1,Db2,phi1,phi2,phib1,phib2,S1,S2,St,R,Tj,coord);
